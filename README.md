...
A lightweight HTTP server built using the cpp-httplib library.

An in-memory Least Recently Used (LRU) cache for fast data access.

A PostgreSQL database that provides persistent storage for key-value data.
